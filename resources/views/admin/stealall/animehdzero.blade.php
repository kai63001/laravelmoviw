        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="box" style="color:white;">
                    Steal  <a href="https://www.animehdzero.com/">AnimeHdzero</a> :
                    <br>
                    <input type="text" id="url" class="form-control" style="background:#c71e2f;border-color:#c71e2f;color:white;" placeholder="Ex. 2738">
                    <br>
                    ...
                    <script>
                         $('#start').click(function(){
                             ...
                             if(url != ""){
                                 ...
                                 window.location='{{ url('') }}/admin/steal/animehdzero/'+url;
                             }
                         });
                    </script>
                </div>
