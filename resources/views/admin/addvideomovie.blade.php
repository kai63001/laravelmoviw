    ...
    <div class="container" style="color:white;">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="cardbox" style="background:#1b2a4d;border-radius:4px;padding:15px;">
                        ...
                        Ifream :
                        <textarea class="form-control" style="background:#284485;border-color:#284485;color:white;" name="m_iframe" id="" cols="30" rows="10" required></textarea>
                        <br>
        ...
        <script>
            $('#find').click(function(){
                ...
                url = "{{ url('') }}/admin/searchmovie/{{ str_replace(' ','+',$video_next['v_name']) }}";
