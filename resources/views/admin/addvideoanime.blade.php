...
<br><br>
    <div class="container" style="color:white;">
        <div class="cardbox" style="background:#1b2a4d;border-radius:4px;padding:15px;">
            <h4>{{ $video_next['v_name'] }}</h4>
        </div>
        <br>
        <form action="{{ route('addmovier') }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-md-3">
                    <div class="cardbox" style="background:#1b2a4d;border-radius:4px;padding:15px;">
                        <img loading="lazy" src="{{ $video_next['v_img'] }}" alt="" width="100%">
                    </div>
                </div>
                <div class="col-md-9">
                    <div class="cardbox" style="background:#1b2a4d;border-radius:4px;padding:15px;">
                        Title Ep:
                        <input type="text" name="a_name" class="form-control"  style="background:#284485;border-color:#284485;color:white;" required>
                        <input type="hidden" name="m_vid" value="{{ $v_id }}">
                        Ifream :
                        <textarea class="form-control" style="background:#284485;border-color:#284485;color:white;" name="m_iframe" id="" cols="4" rows="5" required></textarea>
                        <br>
                        ...
                        <span id="steal" class="btn btn-dark"><i class="fas fa-skull-crossbones"></i> Steal all</span>
        ...
        <?php
            ...
            $cut_name = str_replace(' ','+',$video_next['v_name']);
